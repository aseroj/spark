...
import com.crowley.spark.pairRdd.aggregation.reduceByKey.AvgCount;
...
public class HousePrice {
    public static void main(String[] args) {
        ...
        SparkConf conf = new SparkConf().setAppName("SortedHousePriceAvg").setMaster("local[*]");
        ...
        for (Map.Entry<Integer, AvgCount> housePriceTotalPair : housePriceTotal.collectAsMap().entrySet()) {
        ...
        for (Tuple2<Integer, Double> housePriceAvgPair : sortedHousePriceAvg.collect()) {
            System.out.println(housePriceAvgPair._1() + " : " + housePriceAvgPair._2());
        }
    }
}
